...
public class HelloWorldServiceLocator extends org.apache.axis.client.Service implements mypacakge.HelloWorldService {
    ...
    public mypacakge.HelloWorld_PortType getHelloWorld() throws javax.xml.rpc.ServiceException {
    ...
    public mypacakge.HelloWorld_PortType getHelloWorld(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            mypacakge.HelloWorldSoapBindingStub _stub = new mypacakge.HelloWorldSoapBindingStub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (mypacakge.HelloWorld_PortType.class.isAssignableFrom(serviceEndpointInterface)) {
                mypacakge.HelloWorldSoapBindingStub _stub = new mypacakge.HelloWorldSoapBindingStub(new java.net.URL(HelloWorld_address), this);
                _stub.setPortName(getHelloWorldWSDDServiceName());
                return _stub;
            }
        }
